...
def prefetch_lpr_models(model_cache_dir: Path):
    ...
    download_file(yolov9_url, yolov9_lp_dir / yolov9_model, f"YOLOv9 LPR {yolov9_model}")
...
def main():
    ...
    print(f"Frigate Model Prefetch Script")
    print(f"============================")
    print(f"Target directory: {model_cache_dir}")
    print(f"This script will download all model files required for:")
    print(f"  - Semantic Search (Jina CLIP v1 & v2)")
    print(f"  - Face Recognition (FaceNet & ArcFace)")
    print(f"  - License Plate Recognition (PaddleOCR & YOLOv9)")
    print(f"  - Bird Classification")
    print()
    ...
    try:
        ...
        print(f"2. Mount it as a volume in your Frigate container at /config/model_cache")
        print(f"3. Enable the desired features in your Frigate configuration")
